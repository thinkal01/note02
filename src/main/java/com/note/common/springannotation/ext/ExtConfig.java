package com.note.common.springannotation.ext;
 ...
 *   ContextRefreshedEvent：容器刷新完成（所有bean都创建）会发布这个事件；
 *   ContextClosedEvent：关闭容器会发布这个事件；
 * 4）、发布一个事件：
 * applicationContext.publishEvent()；
 * 原理：
 * 三种事件:ContextRefreshedEvent、IOCTest_Ext$1[source=我发布的事件]、ContextClosedEvent；
 ...
 */
@ComponentScan("com.note.common.springannotation.ext")
@Configuration
