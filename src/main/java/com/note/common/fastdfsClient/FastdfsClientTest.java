package com.note.common.fastdfsClient;
...
public class FastdfsClientTest {
    ...
    public String getFilename() {
        URL resource = Object.class.getResource("/fdfs_client.conf");
        // File file = new File("");
    ...
    public void testUpload() {
        for (int i = 0; i < 1; i++) {
            try {
                ...
                String fileIds[] = storageClient.upload_file(getFilename(), null, nvp);
    ...
    public void testDownload() {
        try {
            ...
            byte[] b = storageClient.download_file("group1", "M00/00/00/wKgZr1vBj6qANqHNAAAGD_VdTDo37.conf");
            if (b != null) {
                System.out.println(b.length);
                saveFile(b, "E:/", UUID.randomUUID().toString() + ".conf");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
