package com.note.common.shiro.ssm.service.impl;

import com.note.controller.exception.CustomException;
import com.note.common.shiro.ini.mapper.ItemsMapper;
import com.note.common.shiro.ini.mapper.ItemsMapperCustom;
...
public class ItemsServiceImpl implements ItemsService {
    ...
    //商品查询列表
    @Override
    public List<Items> findItemsList(QueryVo itemsQueryVo) throws Exception {
    ...
    @Override
    public void updateItems(Integer id, Items itemsCustom) throws Exception {
        //写业务代码
        //对于关键业务数据的非空校验
        if (id == null) {
