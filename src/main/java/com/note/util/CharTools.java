...
public class CharTools {
     ...
     * @return
     */
    public static String src2Dest(String str, String srcCode, String destCode) {
        String returnStr = "";

        try {
            byte[] ascii = str.getBytes(srcCode);
            returnStr = new String(ascii, destCode);
    ...
    public static final String ISO2GB(String text) {
        return src2Dest(text, "ISO-8859-1", "GB2312");
    }
    ...
    public static final String GB2ISO(String text) {
        return src2Dest(text, "GB2312", "ISO-8859-1");
    }
